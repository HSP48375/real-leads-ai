  ...
  return (
    <section className="py-20 md:py-32 relative bg-background overflow-hidden">
      <div className="container px-4">
        ...
        <div className="relative max-w-6xl mx-auto min-h-[2400px] md:min-h-[2200px]">
          {/* SVG Arrow Ribbons */}
          <svg
          ...
          >
            <defs>
              ...
              >
                <polygon
                  ...
                  fill={hoveredRibbon ? "#FFD700" : "#8B7500"}
            ...
            {/* Arrow path connecting all steps */}
            <motion.path
              d="M 70% 8% Q 50% 15%, 15% 25% Q 5% 30%, 10% 35% Q 50% 45%, 70% 55% Q 75% 60%, 70% 65% Q 50% 75%, 15% 85% Q 5% 90%, 10% 95%"
              ...
              style={{
                filter: hoveredRibbon !== null ? "url(#ribbon-glow) drop-shadow(0 0 20px rgba(255, 215, 0, 0.6))" : "none",
              }}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Content card */}
              <motion.div
                className="mt-8 bg-background/80 backdrop-blur-sm border border-border rounded-lg p-6 max-w-md shadow-lg"
